...
var Webdriver = /** @class */ (function () {
    function Webdriver() {
    }
    Webdriver.boot = function () {
    ...
    Webdriver.initProccess = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.driver.wait(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.driver.executeAsyncScript("return document.readyState", function (readyState) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            return [2 /*return*/, readyState === "complete"];
                                        });
                                    }); })];
                                case 1:
                                    _a.sent();
